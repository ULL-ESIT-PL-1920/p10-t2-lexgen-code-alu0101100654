/** 
 * @file Fichero que exporta la función buildLexer
 * @author Florentín Pérez Glez
 * @version 1.0.0
 * @since 01-04-2020
 * @description En este archivo se encuentra la función buildLexer que se
 * encarga de construir una función lexer que actua como analizador léxico
 * por medio de un array de tokens que recibe como argumento.
*/
...
function buildLexer(tokens) {
  return function(stringChain) {
    ...
    if (tokenNames.indexOf('ERROR') !== -1) {
      throw 'Error. No se permite un token de tipo ERROR';
    }
